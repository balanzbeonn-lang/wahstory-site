                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Dear '.$UserName.',
							</p>
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">'.$MemberName.' has requested to <strong>reschedule your meeting</strong> originally set for <strong>'.$MeetingDate.' at '.$MeetingStart.'</strong>.
							</p>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: center; font-size: 16px; margin: 20px 0;">
							    <a href="https://www.wahstory.com/users/" style="background-color: #ec398b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">🔗 Reschedule Meeting</a>
							</p>
