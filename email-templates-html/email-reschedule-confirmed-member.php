...
<head>
  ...
  <title>Your Meeting Request with '.$MemberName.' Was Declined | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">'.$UserName.' has proposed a new time for your meeting after your reschedule request.
							</p>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Proposed New Meeting Time: '.$MeetingDate.' '.$MeetingStart.'
							</p>

                            <p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Please confirm if this new time works for you by clicking the link below:
							</p>

                            <p style="text-align: center; margin: 25px 0;">
                                <a href= "www.wahstory.com/users" style="background-color: #ec398b; color: white; padding: 10px 20px; border-radius: 5px; text-decoration: none; font-weight: bold; font-family: sans-serif;">Confirm Meeting</a>
                            </p>
