...
$HostName = 'Pratham Kakkar';
$MeetingDate = '2 May, 2025';
...
<head>
  ...
  <title>Group Meeting Cancelled – WAHClub</title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Hi Member,
							</p>
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">We wanted to let you know that the WAHClub group meeting scheduled for:
							</p>
							
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; margin-left: 20px; font-size: 16px;">
							<strong>🗓 Date:</strong> '.$MeetingDate.'<br>
							<strong>⏰ Time:</strong> '.$MeetingStart.'<br>
							<strong>👤 Host:</strong> '.$HostName.'
							</p>
							
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">...has been <strong>cancelled</strong>.
							</p>
							
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">We understand plans can shift, and we appreciate your interest in being part of this conversation. If the meeting is rescheduled or a new one is set up, you\'ll be the first to know!
							</p>
							
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Until then, feel free to keep exploring and connecting on WAHClub.
							</p>
