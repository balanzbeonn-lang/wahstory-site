...
<head>
  ...
  <title>Meeting Confirmed with '.$UserName.' | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;"> You have successfully confirmed your meeting with '.$UserName.'. Here are the details:
							<br>
							<strong>Date: </strong> '.$MeetingDate.' <br>
							<strong>Time: </strong> '.$MeetingStart.' - '.$MeetingEnd.' <br>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">
							    '.$UserName.' has been notified, and your meeting is now set. You can view and manage your schedule in your <a href="https://www.wahstory.com/users/">WAHClub dashboard</a>.
							</p> 
