...
<head>
  ...
  <title>You\'re Invited to a Group Meet with '.$HostName.' | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Hey '.$ParticipantName.',
							</p>
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">You\'re invited to join a group meeting on <strong>WAHClub</strong>, hosted by <strong>'.$HostName.'</strong> — someone from your professional circle who\'s sparked a conversation worth having!
							</p>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: center; font-size: 16px; margin: 20px 0;">
							    <a href="'.$MeetingLink.'" style="background-color: #ec398b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">🔗 Join Meeting</a>
							</p>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">See you there!
							</p>
