...
<head>
  ...
  <title>You’ve Declined a Meeting Request from '.$UserName.' | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;"> You have declined the meeting request from '.$UserName.' for '.$MeetingDate.' at '.$MeetingStart.' - '.$MeetingEnd.'. '.$UserName.' has been notified.
							</p>
