...
<head>
  ...
  <title>New Meeting Request from '.$UserName.' | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">You’ve received a new meeting request from '.$UserName.' for a slot on  '.$MeetingDate.' at '.$MeetingStart.' -'.$MeetingEnd.'.
							</p>
							...
							<ul style=" margin-top: 0px; ">
							    ...
							    <strong>Review & Respond:</strong>
							        Go to your <a href="https://www.wahstory.com/users/">WAHClub dashboard</a> to accept or decline the request.
							    </li>
							    <li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							        If you accept, we’ll confirm the meeting and share the details with both of you.
							    </li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							     
							</ul>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;"><a href="https://www.wahstory.com/login">Login now</a> to manage your availability.
							</p>
