...
<head>
  ...
  <title>Your Group Meeting is Scheduled | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Dear '.$HostName.',
							</p>
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Your group meeting on <strong>WAHClub</strong> has been successfully set up! Here are the meeting details:
							</p>
							...
							<strong>Meeting Link:</strong> <a href="'.$MeetingLink.'" style="color: #ec398b;">'.$MeetingLink.'</a>
							</p>
							
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">We\'ve notified members from your selected category, and they\'ll receive an invite to join your discussion.
							</p>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: center; font-size: 16px; margin: 20px 0;">
							    <a href="https://www.wahstory.com/users/" style="background-color: #ec398b; color: white; padding: 10px 20px; text-decoration: none; border-radius: 5px;">🔗 Manage Meeting</a>
							</p>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Thanks for taking the initiative to host this — we\'re excited to see what conversations spark from here!
							</p>
