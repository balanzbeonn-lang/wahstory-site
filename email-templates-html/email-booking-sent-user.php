...
<head>
  ...
  <title>Your Meeting Request with '.$MemberName.' is Pending Confirmation | WAHClub </title>
  <style type="text/css">
                  ...
                  <tr>
                    <td bgcolor="" class="" style="width:100% !important; padding: 0;">
						...
						<tr>
							...
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">Hi '.$UserName.',
							</p>
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">You’ve successfully sent a request to book a meeting with '.$MemberName.' on your selected slot '.$MeetingDate.' at '.$MeetingStart.' - '.$MeetingEnd.'.
							</p>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px; margin-bottom: 0px;">What happens next?
							</p>
							
							<ul style=" margin-top: 0px; ">
							    <li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							        '.$MemberName.' will review your request and either confirm or decline it
							    </li>
							    <li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							        You’ll receive an update once they respond.
							    </li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							    <li style=" font-size: 15px; font-family: sans-serif; font-weight: 500; ">
							        If confirmed, we’ll share the meeting details, including the Google Meet link.
							    </li> 
							</ul>
							 
							<p style="color: #000; font-family: sans-serif; font-weight: 500; text-align: left; font-size: 16px;">In the meantime, you can manage your bookings from your <a href="https://www.wahstory.com/users/">WAHClub dashboard</a>.
							</p>
