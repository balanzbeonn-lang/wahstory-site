  ...
  */
  ...
  function submitting() {
      $('button').click(function() {
        // Find the inner .submitting span and display it
        var submittingSpan = $(this).find('.submitting');
        submittingSpan.css('display', 'block');
  ...
  function mainNav() {
    ...
    $('.header-search i').on('click', function () {
      $('form.searchbar-section').toggleClass('d-block');
    });
...
var words = ["Total Reach", "Content Interaction", "Profile Activity"];
var values = ["90800", "70760", "407"],
    part,
    i = 0,
    offset = 0,
    len = words.length,
...
$(document).ready(function () {
  ...
  // Add this code to hide the submit button when the form is submitted
  $('#Submitloading').submit(function () {
