document.addEventListener("DOMContentLoaded", function() {
    ...
    var m = new FullCalendar.Calendar(e, {
        ...
        eventClick: function(e) {
            document.getElementById("btn-delete-event").style.display = "block", n.show(), a.reset(), document.getElementById("event-title").value[0] = "", l = e.event, document.getElementById("event-title").value = l.title, document.getElementById("event-category").value = l.classNames[0], d = null, t.innerText = "Edit Event", d = null
        },
        dateClick: function(e) {
            document.getElementById("btn-delete-event").style.display = "none", r(e)
        },
        events: s
    });
    m.render(), a.addEventListener("submit", function(e) {
        ...
        document.getElementById("btn-delete-event").style.display = "none", r({
            date: new Date,
            allDay: !0
        })
    })
