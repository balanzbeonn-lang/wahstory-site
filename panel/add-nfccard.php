...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $resp = $postObj->GetNFCcardDetilsUserId($_POST["userID"]);
    
    var_dump($resp);
    
    $_SESSION["response"]  = $postObj->AddNFCcard();
}
...
if (isset($_SESSION["response"])) {
    ...
    switch ($_SESSION["response"]) {
        ...
        case "Error1": {
                ...
                'Details Already Added Kindly Update!','',
                    ...
                    <div class="card">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-header">
                                ...
                                <h4>Add New NFC Card &nbsp; &nbsp; OR &nbsp; &nbsp;  <a href='update-nfccard' class='btn btn-primary'>Update Details</a></h4>
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <select class="form-control selectric" name="userID" required>
                    ...
                    <?php endforeach; ?>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="email" value="email" id="emailCheckbox">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                       ...
                                       <input class="form-check-input" type="checkbox" name="linkedin" value="linkedin" id="linkedinCheckbox">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        ...
                                        <input class="form-check-input" type="checkbox" name="instagram" value="instagram" id="instagramCheckbox">
                            ...
                            <select class="form-control selectric" name="status" id="StatusSelect">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Card Back Image</label>
