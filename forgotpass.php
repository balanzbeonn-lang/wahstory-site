...
session_start();
    ...
    if($_POST['VCode'] === $_SESSION['Mailotp']){
        ...
        if (isset($_SESSION['Mailotp_time'])) { 
            ...
            if (($currentTime - $otpTime) <= $validityPeriod) {
                ...
                $SucMessage = "Please check your email, A verification code has been sent on your email to verify your account.";
                ...
                header('location: /users/user.changepassword.php');
    ...
    if(isset($_POST['ResetPassword'], $_POST["email"])){
        
        $_SESSION['response'] = $postObj->SendOtpForgotPassword($_POST["email"]);
              ...
              <form action="" method="post" id="Submitloading">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-12 col-md-12">
                    ...
                    <button class="cs-btn cs-style1" type="submit" name="ResetPassword">
