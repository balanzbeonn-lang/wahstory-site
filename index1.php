...
<head>
    ...
    .cs-isotop_item.ui_ux_design.all{
 ...
 <!-- Start Hero -->
    <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/images/banner-front.webp" id="home">
      <div class="container">
        ...
        <div class="cs-funfact_wrap cs-type1">
          ...
          <div class="cs-funfact_right" id="homeinsights">
            <div class="cs-funfacts">
              ...
              <div class="cs-funfact cs-style1">
                <div class="cs-funfact_number cs-primary_font cs-semi_bold cs-primary_color">
                  <span data-count-to="200" class="odometer"></span>k
                </div> 
                <div class="cs-funfact_text">
                  <span class="cs-accent_color">+</span>
                  <p>Social Reach</p>
    ...
    <div id="mid-sections">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="loading-subtitle skeleton-loader" style="width: 80%;"></div>
