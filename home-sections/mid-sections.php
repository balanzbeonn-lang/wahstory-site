...
<!-- Start Blog Section -->
    <section class="cs-shape_wrap_4 cs-parallax" id="featured-stories">
        <div class="cs-shape_4 cs-to_up"></div>
      <div class="cs-shape_4 cs-to_right shapewithtext"><a href="/shareyourstory/" title="Share Your Story"> Let <br> the world <br> see YOU! </a></div>
      <div class="cs-height_150 cs-height_lg_80"></div>
      <div class="container">
        <div class="cs-slider cs-style1 cs-gap-24">
          <div class="cs-slider_left">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle">Igniting Emotion, Inspiring Action!</h3>
              <h2 class="cs-section_title">Featured Stories</h2>
            </div>
          </div>
          <div class="cs-slider_right">
            <div class="cs-post_wrap">
             ...
             <?php
        		foreach ($postObj->getLatestStories(11, "Top") as $story) {
                    ...
                    <div class="cs-post cs-style1 ">
                      ...
                      <div class="cs-post_info">
                        ...
                        <h2 class="cs-post_title">
                          <a href="/story/<?=$story['slug']?>"><?=$story['title']?>ss</a>
                        </h2>
                      </div>
                    </div>
                  </div>
 ...
 <!-- Start Blog Section -->
	 ...
	 <div class="cs-height_90 cs-height_lg_70"></div>
      ...
      <div class="container">
        <div class="cs-portfolio_1_heading">
          <div class="cs-section_heading cs-style1">
            <h3 class="cs-section_subtitle">Stories that Ignite Inspiration</h3>
            <h2 class="cs-section_title">Inspiring Stories</h2>
          </div>
          <div class="cs-isotop_filter cs-style1">
            <ul class="cs-mp0 cs-center" id="filter-list">
              <li class="active"><a href="#" data-filter=".all">All</a></li>
              <li><a href="#" data-filter=".9">Her Story</a></li>
              <li><a href="#" data-filter=".8">Game Changer</a></li>
              <li><a href="#" data-filter=".10">Passion Story</a></li>
              <li><a href="#" data-filter=".11">Pride Story</a></li>
              <li><a href="#" data-filter=".22">Influencers</a></li>
              <li><a href="#" data-filter=".16">Living Well</a></li>
            </ul>
          </div>
        </div>
        <div class="cs-height_50 cs-height_lg_50"></div>
        ...
        $i = 1;
        //All Story
        foreach ($postObj->getnewStories(6) as $storyrow) { 
            //for Amit Kapoor
            if($storyrow["id"] == 436){
                continue;
            }
        ?>
          <div class="cs-isotop_item ui_ux_design all">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
              <div class="cs-portfolio_bg cs-bg" data-src="<?=BASE_URL?>/images/posts/<?php echo $storyrow["img"]; ?>"></div>
              <div class="cs-portfolio_info">
                <div class="cs-portfolio_info_bg cs-accent_bg"></div>
                <h2 class="cs-portfolio_title"><?=$storyrow["author"]?></h2>
                <div class="cs-portfolio_subtitle">Know More</div>
              </div>
            </a>
          </div><!-- .cs-isotop_item -->
         ...
         <?php } 
        //Her Story
        foreach ($postObj->getStoriesByCat(22, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
              <div class="cs-portfolio_bg cs-bg" data-src="<?=BASE_URL?>/images/posts/<?php echo $storyrow["img"]; ?>"></div>
              <div class="cs-portfolio_info">
         ...
         <?php } 
         //Gamechaner
         foreach ($postObj->getStoriesByCat(16, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
         ...
         //Passion Story
         foreach ($postObj->getStoriesByCat(10, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
         ...
         <?php } 
         //Pride Story
         foreach ($postObj->getStoriesByCat(11, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
         ...
         <?php } 
         //Pride Story
         foreach ($postObj->getStoriesByCat(8, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
         ...
         <?php }//Pride Story
         foreach ($postObj->getStoriesByCat(9, 3) as $storyrow) { 
        ?>
          <div class="cs-isotop_item ui_ux_design  <?=$storyrow['category']?>">
            <a href="/story/<?php echo $storyrow["slug"] ?>" class="cs-portfolio cs-style1 cs-type1 grayscale-img">
              <div class="img-scale cs-portfolio_hover"></div>
        ...
        <div class="text-center">
          <a href="/stories" class="cs-text_btn">
            <span>View More</span>
    ...
    <section id="wahverse-section"></section>
        ...
        <div class="container-fluid">
            <div class="cs-slider cs-style2 cs-gap-24">
             ...
             <div class="container">   
                <div class="cs-slider_heading cs-style1">
                    ...
                    <div class="cs-section_heading cs-style1">
                      <!--<h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"> Stories on the Rise </h3>-->
                      <h2 class="cs-section_title">Latest News</h2>
                    </div>
            ...
            ?>
                      ...
                      <div class="card-body"> 
                       ...
                       <a href="<?=$newsrow['sourceURL']?>" class="text-small readmorebtn btns">Read More <i class="fa fa-arrow-right"></i></a>
                      </div> 
    ...
    <section>
      <div class="container">
        <div class="cs-slider cs-style2 cs-gap-24">
          <div class="cs-slider_heading cs-style1">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s"> Get to Know Us </h3>
              <h2 class="cs-section_title">Meet Our Team </h2>
            </div>
            <div class="cs-slider_arrows cs-style1 cs-primary_color">
              <div class="cs-left_arrow cs-center">
                <svg width="26" height="13" viewBox="0 0 26 13" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div class="cs-slider_container" data-autoplay="0" data-loop="1" data-speed="600" data-center="0" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="3" data-lg-slides="4" data-add-slides="4">
            <div class="cs-slider_wrapper">
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Amit-Kapoor.webp" alt="Amit Kapoor" loading="lazy"/>
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/amitkapoor-ehrs/" target="_blank" rel="noopener" aria-label="Visit Amit Kapoor’s LinkedIn profile (opens in a new tab)">Amit Kapoor</a>

                    </h2>
                    <div class="cs-member_designation">Founder & Managing Director</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/amitkapoor-ehrs/" target="_blank">
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Neha-Bajaj-Kapoor.webp" alt="Neha Bajaj Kapoor" loading="lazy" />
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/neha-bajaj-kapoor-42214a173" 
   target="_blank" 
   rel="noopener" 
   aria-label="Visit Neha Bajaj Kapoor’s LinkedIn profile (opens in a new tab)">
   Neha Bajaj Kapoor
</a>
                    </h2>
                    <div class="cs-member_designation">Chief Officer</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/neha-bajaj-kapoor-42214a173" target="_blank">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.39756 18.333H1.9422V7.20581H5.39756V18.333ZM3.66802 5.68795C2.56311 5.68795 1.6669 4.77277 1.6669 3.66786C1.6669 3.13714 1.87773 2.62814 2.25301 2.25286C2.6283 1.87758 3.13729 1.66675 3.66802 1.66675C4.19875 1.66675 4.70774 1.87758 5.08302 2.25286C5.4583 2.62814 5.66913 3.13714 5.66913 3.66786C5.66913 4.77277 4.77256 5.68795 3.66802 5.68795ZM18.3298 18.333H14.8819V12.9164C14.8819 11.6255 14.8559 9.96995 13.0854 9.96995C11.2889 9.96995 11.0136 11.3725 11.0136 12.8234V18.333H7.56199V7.20581H10.876V8.72367H10.9243C11.3857 7.84941 12.5125 6.92679 14.1937 6.92679C17.6907 6.92679 18.3336 9.22962 18.3336 12.2207V18.333H18.3298Z" fill="currentColor" />
                      </svg>
                    </a> 
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Neha-Sahni.webp" alt="Neha Sahni" loading="lazy" />
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/neha-sabherwal-73988b15/" 
   target="_blank" 
   rel="noopener" 
   aria-label="Visit Neha Sahni (Neha Sabherwal) LinkedIn profile (opens in a new tab)">
   Neha Sahni
</a>

                    </h2>
                    <div class="cs-member_designation">AD - Talent Acquisition</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/neha-sabherwal-73988b15/" target="_blank">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.39756 18.333H1.9422V7.20581H5.39756V18.333ZM3.66802 5.68795C2.56311 5.68795 1.6669 4.77277 1.6669 3.66786C1.6669 3.13714 1.87773 2.62814 2.25301 2.25286C2.6283 1.87758 3.13729 1.66675 3.66802 1.66675C4.19875 1.66675 4.70774 1.87758 5.08302 2.25286C5.4583 2.62814 5.66913 3.13714 5.66913 3.66786C5.66913 4.77277 4.77256 5.68795 3.66802 5.68795ZM18.3298 18.333H14.8819V12.9164C14.8819 11.6255 14.8559 9.96995 13.0854 9.96995C11.2889 9.96995 11.0136 11.3725 11.0136 12.8234V18.333H7.56199V7.20581H10.876V8.72367H10.9243C11.3857 7.84941 12.5125 6.92679 14.1937 6.92679C17.6907 6.92679 18.3336 9.22962 18.3336 12.2207V18.333H18.3298Z" fill="currentColor" />
                      </svg>
                    </a> 
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Aditi-chandnani.webp" alt="Aditi Chandnani" loading="lazy" />
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/aditichandnani/" 
   target="_blank" 
   rel="noopener" 
   aria-label="Visit Aditi Chandnani’s LinkedIn profile (opens in a new tab)">
   Aditi Chandnani
</a>
                    </h2>
                    <div class="cs-member_designation">Executive Board Member & Strategic Advisor</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
              ...
              <div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Kuldeep-Tehlan.jpg" alt="Kuldeep Tehlan" loading="lazy" />
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/kuldeep-tehlan-132a181a2/" 
   target="_blank" 
   rel="noopener" 
   aria-label="Visit Kuldeep Tehlan’s LinkedIn profile (opens in a new tab)">
   Kuldeep Tehlan
</a>
                    </h2>
                    <div class="cs-member_designation">Procurement Head</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/kuldeep-tehlan-132a181a2/" target="_blank">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.39756 18.333H1.9422V7.20581H5.39756V18.333ZM3.66802 5.68795C2.56311 5.68795 1.6669 4.77277 1.6669 3.66786C1.6669 3.13714 1.87773 2.62814 2.25301 2.25286C2.6283 1.87758 3.13729 1.66675 3.66802 1.66675C4.19875 1.66675 4.70774 1.87758 5.08302 2.25286C5.4583 2.62814 5.66913 3.13714 5.66913 3.66786C5.66913 4.77277 4.77256 5.68795 3.66802 5.68795ZM18.3298 18.333H14.8819V12.9164C14.8819 11.6255 14.8559 9.96995 13.0854 9.96995C11.2889 9.96995 11.0136 11.3725 11.0136 12.8234V18.333H7.56199V7.20581H10.876V8.72367H10.9243C11.3857 7.84941 12.5125 6.92679 14.1937 6.92679C17.6907 6.92679 18.3336 9.22962 18.3336 12.2207V18.333H18.3298Z" fill="currentColor" />
                      </svg>
                    </a>
              ...
              <!--<div class="cs-slide">
                <div class="cs-team cs-style1">
                  <div class="cs-member_thumb">
                    <img src="assets/images/team/Akshay-Bhatia.webp" alt="Akshay Bhatia" loading="lazy"/>
                    <div class="cs-member_overlay"></div>
                  </div>
                  <div class="cs-member_info">
                    <h2 class="cs-member_name">
                      <a href="https://www.linkedin.com/in/akshay-bhatia-847368159/" target="_blank">Akshay Bhatia</a>
                    </h2>
                    <div class="cs-member_designation">Project Manager - Branding & Marketing</div>
                  </div>
                  <div class="cs-member_social cs-primary_color">
                    <a href="https://www.linkedin.com/in/akshay-bhatia-847368159/" target="_blank">
                      <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M5.39756 18.333H1.9422V7.20581H5.39756V18.333ZM3.66802 5.68795C2.56311 5.68795 1.6669 4.77277 1.6669 3.66786C1.6669 3.13714 1.87773 2.62814 2.25301 2.25286C2.6283 1.87758 3.13729 1.66675 3.66802 1.66675C4.19875 1.66675 4.70774 1.87758 5.08302 2.25286C5.4583 2.62814 5.66913 3.13714 5.66913 3.66786C5.66913 4.77277 4.77256 5.68795 3.66802 5.68795ZM18.3298 18.333H14.8819V12.9164C14.8819 11.6255 14.8559 9.96995 13.0854 9.96995C11.2889 9.96995 11.0136 11.3725 11.0136 12.8234V18.333H7.56199V7.20581H10.876V8.72367H10.9243C11.3857 7.84941 12.5125 6.92679 14.1937 6.92679C17.6907 6.92679 18.3336 9.22962 18.3336 12.2207V18.333H18.3298Z" fill="currentColor" />
                      </svg>
                    </a> 
    ...
    <!-- End Team Section -->
    <div class="cs-height_90 cs-height_lg_60"></div>
    ...
    <section class="cs-gradient_bg_1 cs-shape_wrap_3 cs-parallax">
      ...
      <div class="container">
        ...
        <?php foreach ($postObj->getTestimonials(100) as $testimonial) { ?>
              <div class="slider-for_item item-nav">
                <div class="slider-nav_item">
                  <div class="cs-rotate_img">
                    <div class="cs-rotate_img_in">
                      <img src="assets/images/testimonials/<?=$testimonial['profile_pic']?>" alt="<?=$testimonial['title']?>" loading="lazy" />
                    </div>
                  </div>
                </div>
              </div>
    ...
    <?php
	foreach ($postObj->getTestimonials(100) as $testimonial) {
	...
	?>
              <div class="slider-for_item">
                <div class="cs-testimonial cs-style1">
                  ...
                  <div class="cs-testimonial_text"> <?php echo $testimonial["msg"] ?> </div>
                  
                  <h4 class="cs-testimonial_avatar_name"> </h4>
                  <div class="cs-testimonial_avatar_designation text-uppercase"> <?php echo $testimonial["title"] ?> </div>
                </div>
              </div>
 ...
 <?php $Blogs = $postObj->getBlogs(20); ?>
 
    <!-- Start Blog Section -->
    <section class="cs-shape_wrap_4 cs-parallax">
      <div class="cs-shape_4 cs-to_up"></div>
      <div class="cs-shape_4 cs-to_right shapewithtext">
          <a href="/blog/" title="Share Your Story"> Stay <br> INFORMED! </a>
      </div>
      ...
      <div class="container">
        <div class="cs-slider cs-style1 cs-gap-24">
          <div class="cs-slider_left">
            <div class="cs-section_heading cs-style1">
              <h3 class="cs-section_subtitle">Uncover the Latest Blogs</h3>
              <h2 class="cs-section_title">Explore recent publication</h2>
              <div class="cs-height_45 cs-height_lg_20"></div>
              <a href="/blogs" class="cs-text_btn wow fadeInLeft" data-wow-duration="0.8s" data-wow-delay="0.2s">
            ...
            <div class="cs-post_wrap">
              <div class="cs-slider_container" data-autoplay="1" data-loop="1" data-speed="1000" data-center="0" data-variable-width="1" data-slides-per-view="responsive" data-xs-slides="1" data-sm-slides="2" data-md-slides="2" data-lg-slides="2" data-add-slides="3">
                ...
                <?php
                  ...
                  <div class="cs-slide">
                    <div class="cs-post cs-style1 ">
                      <a href="/blog/<?=$blog["slug"];?>" class="cs-post_thumb grayscale-img img-scale" style="background-image: url('/images/blogs/<?=$blog["img"] ?>'); background-size: cover;"> 
                        <div class="cs-post_overlay"></div>
                      </a>
                      <div class="cs-post_info">
                        <div class="cs-posted_by"><?php echo $blog["date"] ?></div>
                        <h2 class="cs-post_title">
                          <a href="/blog/<?=$blog["slug"];?>"><?php echo $blog["title"] ?></a>
                        </h2>
                      </div>
                    </div>
                  </div>
