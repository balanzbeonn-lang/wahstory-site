...
<head>
  ...
  <title>My Stories | <?=$Userrow['name']?></title>
      ...
      <div class="col-lg-9 single-profile">
         ...
         <form id="addproducts" action="" method="POST" enctype="multipart/form-data"> 
          ...
          <div class="col-sm-12"> 
            ...
            <div class="col-sm-12">
                <select class="cs-form_field" placeholder="Select Story Category" name="story_type">
                    <option value="">Select Category</option>
                    <option value="her">Her Story</option>
                    <option value="game_changer">Game Changer</option>
                    <option value="passion">Passion Story</option>
                    <option value="pride">Pride Story</option>
                    <option value="influencer">Influencer</option>
                    <option value="living_well">Living Well</option>
                </select>
                <div class="cs-height_20 cs-height_lg_20"></div>
            </div>
            
            <div class="col-sm-12"> 
            <input type="text" class="cs-form_field" name="productlink" placeholder="Quote"> 
            <div class="cs-height_20 cs-height_lg_20"></div>
          </div>
