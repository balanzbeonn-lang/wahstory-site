<?php 
    ...
    if(isset($_POST['UpdateSkills'])){
        ...
        $DelResp = $postObj->DeleteAllSkillsByUser($Userrow['ClubId']);
        ...
        if($DelResp == 'success') {
            $_SESSION['responce'] = $postObj->UpdateSelectedSkills( $SelectedSkills, $Userrow['ClubId']);  
        }
    ...
    if($_SESSION['responce']!=''){
        switch($_SESSION['responce']){
            case 'SUCCESS':
                ...
                header('location: update.skills.php?sucmsg='.$message);
                break;
            case 'ERROR':
      ...
      <div class="col-lg-9 single-profile">
          ...
          <div class="row"> 
            <div class="col-sm-12">  
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="mb-2">Update Your Skills</h4>
        ...
        <div class="row">
            <div class="col-md-12">   
            	...
            	<div id="skills-container" class="mb-4">
            		...
            		<small class="field-instruction">Add the skills that best reflect your areas of expertise. </small>
            		<br>
            		<label>Please select upto 3</label> 
            		
            		<select id="MultipleSkillSelect" class="cs-form_field" name="skills[]" multiple="multiple">
        
        <?php
            $selectedSkills = $postObj->GetWAHClubUserSkillById($Userrow['ClubId']);
            
            foreach ($selectedSkills as $skill1) {
        ?>
        
        <option value="<?=$skill1['skill_id'];?>" selected><?=$skill1['skill'];?></option>
        
        
        <?php 
            }
            
            $skills = $postObj->GetWAHClubAllSkills();  
            if($skills != '') {
        ...
        <?php } } ?>
          ...
          <div class="col-lg-12">  
            ...
            <button class="cs-btn cs-style1" type="submit" name="UpdateSkills">
    ...
    <script> 
       $(document).ready(function() {          
         ...
         $('#MultipleSkillSelect').select2({
          tags: false,
            placeholder: "Search any skill *", // Set the placeholder text
