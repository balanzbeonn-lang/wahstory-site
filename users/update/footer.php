              ...
              <div class="cs-footer_item">
                ...
                <div class="cs-newsletter cs-style1">
                  ...
                  <form action="" class="cs-newsletter_form mt-3 SubscribeForm SubscribeForms" method="post">
                    <input type="email" class="cs-newsletter_input" name="SubscriberEmail" autocomplete="off" placeholder="Enter Email" required />
                  <br>
      ...
      <div class="container">
        <div class="cs-bottom_footer">
          <div class="cs-bottom_footer_left">
            <div class="cs-copyright"><?=date('Y');?> © <a href="/" target="_blank" style="color: #FFFFFF;">www.wahstory.com</a>. All rights reserved.</div>
          </div>
