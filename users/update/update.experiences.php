<?php 
    ...
    include('inc/update_experience.php');
    $UtilityObj = new ExpUtility();
    ...
    if(isset($_POST['UpdateEXP'])){
        ...
        $_SESSION['responce'] = $UtilityObj->UpdateUserExperience($Userrow['ClubId']);
    }
    
    if($_SESSION['responce']!=''){
        if($_SESSION['responce'] == 'SUCCESS') {
            $message = 'Updated Successfully!';
            echo '<script>window.location.href="update.experiences.php?sucmsg='.$message.'"</script>';
        } else {
            $message = 'Something went wrong!';
            echo '<script>window.location.href="update.experiences.php?errmsg='.$message.'"</script>';
        }
...
<head>
  ...
  <title>Update Experience | <?=$Userrow['name']?></title>
 ...
 <!-- Start Hero -->
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9 single-profile">
          ...
          <div class="row"> 
            <div class="col-sm-12">  
              <div class="d-flex align-items-center justify-content-between">
                <h4 class="mb-2">Update Your Experience</h4>
                <a href="/users/user.profile.php" style="color: #e9204f;" class="h3"><i class="fa fa-times"></i></a>
              </div>
              
              <small class="field-instruction">(Share up to <?=$addable_exp_count?> experiences that highlight your journey and impact) </small>
        ...
        <input type="hidden" value="<?=$exp['id'];?>" name="exp<?=$i?>id">
        
        
            <div class="row">
                <div class="col-sm-6 mt-2">
                    <h6 class="mb-2 cs-font_20"> Experience <?=$i?> details: </h6>
                </div>
            </div>
            ...
            <div class="row"> 
                <div class="col-md-6"> 
                    ...
                    <input type="text" class="cs-form_field" name="exp<?=$i?>company" placeholder="Enter Company Name *" autocomplete="off" value="<?=$exp['company_name'];?>" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
              
                <div class="col-md-6"> 
                    <label>Role In The Company *</label>
                    <input type="text" class="cs-form_field" name="exp<?=$i?>role" placeholder="Your Role In The Company *" autocomplete="off" value="<?=$exp['role'];?>" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
                ...
                <div class="col-md-6"> 
                    ...
                    <select name="exp<?=$i?>start-month" class="cs-form_field" required>
                    ...
                    <select name="exp<?=$i?>start-year" class="cs-form_field selectyear" required><option value="">Select Year</option>
            ...
            ?>
                    ...
                    <input type="checkbox" id="exp<?=$i?>currentworking" name="exp<?=$i?>currentworking" value="1" class="form-checkbox required form-check-input" onchange="toggleExpInput('<?=$i?>')" <?=$checked;?>> 
                    
                    <span class="cs-font_10">I am currently working in this role</span></label> 
                    
                    <div class="row">
                        <div class="col-md-6"> 
                        
                    <select name="exp<?=$i?>end-month" class="cs-form_field" required <?=$disabled;?>>
                        <option value="">Select Month</option>
                        
                <?php if($exp['present'] == NULL) { ?>
                ...
                <?php } ?> 
                    ...
                    <select name="exp<?=$i?>end-year" class="cs-form_field selectyear" required <?=$disabled;?>>
                ...
                <div class="col-md-12 mt-4"> 
                    ...
                    <div class="form_group">
                        <label>Description of Responsibilities and
                          Achievements * </label>
                        <textarea name="exp<?=$i?>desc" rows="5" class="cs-form_field editableTextarea" placeholder="Write Your Answer *" autocomplete="off" oninput="checkWordLen(this, 150)" onblur="truncateExcess(this, 150)" required=""><?=$exp['description'];?></textarea>
        ...
        <?php   } } else {?>
            ...
            <div class="row"> 
                <div class="col-md-6"> 
                    <label>Company Name *</label> 
                    <input type="text" class="cs-form_field" name="exp1company" placeholder="Enter Company Name *" autocomplete="off" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
              
                <div class="col-md-6"> 
                    <label>Role In The Company *</label>
                    <input type="text" class="cs-form_field" name="exp1role" placeholder="Your Role In The Company *" autocomplete="off" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
                ...
                <div class="col-md-6"> 
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
							...
							<select name="exp1start-month" class="cs-form_field" required>
								<option value="">Select Month</option>						
								<option value="01">January</option>
								<option value="02">February</option>
								<option value="03">March</option>
                        ...
                        <div class="col-md-6">                             
							...
							<select name="exp1start-year" class="cs-form_field selectyear" required>
								<option value="">Select Year</option>
							</select> 
							<div class="cs-height_20 cs-height_lg_20"></div>
                ...
                <div class="col-md-6 toexp"> 
                    ...
                    <input type="checkbox" id="exp1currentworking" name="exp1currentworking" value="1" class="form-checkbox required form-check-input" onchange="toggleExpInput('1')"> 
                    ...
                    <div class="row">
                        <div class="col-md-6"> 
							...
							<select name="exp1end-month" class="cs-form_field" required>
								<option value="">Select Month</option>
								<option value="01">January</option>
								<option value="02">February</option>
								<option value="03">March</option>
                        ...
                        <div class="col-md-6">
							...
							<select name="exp1end-year" class="cs-form_field selectyear" required>								
								<option value="">Select Year</option>								
							</select> 
							<div class="cs-height_20 cs-height_lg_20"></div>
                ...
                <div class="col-md-12 mt-4"> 
                    ...
                    <div class="form_group">
                        <label>Description of Responsibilities and
                          Achievements * </label>
                        <textarea name="exp1desc" rows="5" class="cs-form_field editableTextarea" placeholder="Write Your Answer *" autocomplete="off" oninput="checkWordLen(this, 150)" onblur="truncateExcess(this, 150)" required=""></textarea>
                        <p class="word-counter success">0/150 Words</p>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 text-right">
                    <div> 
                        ...
                        <a href="javascipt:void(0)" id="addExperienceButton" class="addmorebtn"> <i class="fa fa-plus-circle"></i> Add More </a>
                     &nbsp; &nbsp; &nbsp; &nbsp; 
                        <button class="cs-btn cs-style1 small py-2" type="submit" name="UpdateEXP">
  ...
  <script> 
        function toggleExpInput(expNumber) {
            ...
            const endmonth = document.getElementsByName(`exp${expNumber}end-month`);
            const endyear = document.getElementsByName(`exp${expNumber}end-year`);
...
<script>
    ...
    /*function editableTextarea() {
        document.querySelectorAll('.editableTextarea').forEach((textarea) => {
            if (!textarea.classList.contains('ckeditor-initialized')) {
                ClassicEditor
                    ...
                    .then(() => {
                        textarea.classList.add('ckeditor-initialized'); // Mark as initialized
                    })
                    .catch(error => {
                        console.error(error);
                    });
    ...
    */
    ...
    <script>
        ...
        if(ExperiencesCount >= <?=$addable_exp_count?>) {
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h6 class="mb-2 cs-font_20"> Experience ${ExperiencesCount} details: </h6>
                </div>
            ...
            <div class="row"> 
                <div class="col-md-6"> 
                    <label>Company Name *</label> 
                    <input type="text" class="cs-form_field" name="exp${ExperiencesCount}company" placeholder="Enter Company Name *" autocomplete="off" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
              
                <div class="col-md-6"> 
                    <label>Role In The Company *</label>
                    <input type="text" class="cs-form_field" name="exp${ExperiencesCount}role" placeholder="Your Role In The Company *" autocomplete="off" required="">
                    <div class="cs-height_30 cs-height_lg_40"></div>
                </div>
                ...
                <div class="col-md-6"> 
                    ...
                    <select name="exp${ExperiencesCount}start-month" class="cs-form_field" required>
                        <option value="">Select Month</option>
                        <option value="01">January</option>
                        <option value="02">February</option>
                        <option value="03">March</option>
                    ...
                    <select name="exp${ExperiencesCount}start-year" class="cs-form_field selectyear" required><option value="">Select Year</option></select> 
                    <div class="cs-height_20 cs-height_lg_20"></div>
                ...
                <div class="col-md-6"> 
                    ...
                    <span class="text-center p-0 m-0" style="color: #e9204f;">
                     ...
                     &nbsp;
                     &nbsp;
                    <input type="checkbox" id="exp${ExperiencesCount}currentworking" name="exp${ExperiencesCount}currentworking" value="1" class="form-checkbox required form-check-input" onchange="toggleExpInput('${ExperiencesCount}')" required="required"> 
                    ...
                    <select name="exp${ExperiencesCount}end-month" class="cs-form_field" required>
                    ...
                    <select name="exp${ExperiencesCount}end-year" class="cs-form_field selectyear" required>
                ...
                <div class="col-md-12 mt-4"> 
                    ...
                    <div class="form_group">
                        <label>Description of Responsibilities and
                          Achievements * </label>
                        <textarea name="exp${ExperiencesCount}desc" rows="5" class="cs-form_field editableTextarea" placeholder="Write Your Answer *" autocomplete="off" oninput="checkWordLen(this, 150)" onblur="truncateExcess(this, 150)" required=""></textarea>
                        <p class="word-counter success">0/150 Words</p>
                    </div>
