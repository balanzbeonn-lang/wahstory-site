  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-9 single-profile">
          ...
          <div class="row">
            <div class="col-sm-9"> 
                <h4 class="mb-2">Liked Stories</h4>
            </div>
        ...
        <?php $reactedStoriesSql = $postObj->GetreactedstoriesByUID($_SESSION['userid']); 
        if($reactedStoriesSql != NULL){
        foreach($reactedStoriesSql as $reactedStory){
            
            $Storydata = $postObj->getStoryByID($reactedStory['storyid']);
        ?>
                    <div class="col-md-3">
        ...
        <?php } }else{ ?>
            <div class="col-md-12">
                <p>I haven't liked any story yet.</p>
            </div>
        <?php }  ?>
