...
session_start(); 
    ...
    function addbutton($page){
        echo '<a href="'.$page.'" class="edit-button"><i class="fa fa-plus"></i> Add</a>';
    }
    function editbutton($page){
        echo '<a href="'.$page.'" class="edit-button"><i class="fa fa-edit"></i> Edit</a>';
    }
 ...
 <?php include('breadcrump.php');?>
  ...
  <div class="container">
       ...
       <div class="row">
        <div class="col-sm-12"> 
            ...
            <div class="profile-section row">
                <div class="col-md-12 col-lg-12 col-xl-6 card-cover mb-2">
                    <div class="profile-card card">
                        <a href="update/update.profile.php" class="edit-button"><i class="fa fa-edit"></i> Edit</a> 
            ...
            ?> 
                                ...
                                <img src="/wahclub/public/img/photos/<?=$clubuser['photo']?>">
            ...
            <?php } ?>
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-6 mt-lg-4 mb-2">
    ...
    <?php  }   ?>
        ...
        ?>
                        <div class="mt-4">
                            <h5>Club Story <a href="update/update.story.php" class="editbtn"><i class="fa fa-edit"></i> Edit</a> </h5>
                            <div class="story-title-area p-3 mt-3" style="background: rgba(255,255,255,0.05); border-radius: 8px;">
                                <h5>Story Title</h5>
                                <p class="text-white-50">
        ...
        <?php $clubuser = $postObj->GetWAHClubUserById($Userrow['ClubId']);  ?>
            ...
            <h5 class="mt-4">Career Highlights <a href="update/update.stats.php" class="editbtn"><i class="fa fa-edit"></i> Edit</a></h5>
    ...
    <?php if($WAHStory != NULL) { ?>
        ...
        <?php $clubuser = $postObj->GetWAHClubUserById($Userrow['ClubId']);  ?>
            ...
            <h5>Career Highlights <a href="update/update.stats.php" class="editbtn"><i class="fa fa-edit"></i> Edit</a></h5>
            ...
            <div class="row mt-4">
                <div class="col-md-12 col-lg-12 col-xl-12  card-cover">
                    <div class="info-card card">
                        ...
                        <div class="mt-4">
                            <h5>Core Skills <a href="update/update.skills.php" class="editbtn"><i class="fa fa-edit"></i> Edit</a> </h5>
                ...
                <?php } ?>
                        ...
                        <div class="mt-4">
                            <h5>Your Tools <a href="update/update.tools.php"  class="editbtn"><i class="fa fa-edit"></i> Edit</a></h5>
                            <div class="skill-tags">
                ...
                <?php } ?>
                        ...
                        <div class="mt-4">
                            <h5>Your Traits <a href="update/update.attributes.php" class="editbtn"><i class="fa fa-edit"></i> Edit</a></h5>
                            <div class="skill-tags">
                <?php 
                ...
                <div class="col-xl-12 card-cover">
                    ...
                    ?>
                            <div class="timeline-item">
                                <h5><?=$edu['degree']?></h5>
                                <p><?=date('Y', strtotime($edu['yearfrom']));?> -
                                <?php
                                    echo $edu['yearto'] ? date('Y', strtotime($edu['yearto'])) : 'Present';
                                ?>
            ...
            <div class="row mt-4">
                <div class="col-xl-12 card-cover">
                    ...
                    ?>
                            ...
                            <?php 
                                echo $exp['durationto'] ? date('Y', strtotime($exp['durationto'])) : 'Present';
