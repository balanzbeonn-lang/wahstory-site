    ...
    <div class="row">
      ...
      <div class="col-lg-9">
        ...
        <div class="row">
           ...
           <div class="col-md-12 col-lg-8 text-lg-end text-white pb-2"> 
                <?php 
                    if(empty($Userrow['gender']) || empty($Userrow['starsign']) || empty($Userrow['city']) || empty($Userrow['country'])) { 
                ?>
                    <i class="fa-solid fa-id-card me-2"></i> <a href="/users/update/update.quicks.php?UpdateQuickProfile">  Update Some quick information <span class="cs-btn cs-style2 py-1 px-3 cs-font_11 mt-2 ViewPostBtn text-white">Update </span> </a>
                <?php } ?>
           </div>
           <div class="col-sm-12">
              <hr class="mb-2">
            ...
            <?php 
                if(isset($MyCLubUserRow['subscription_status']) && $MyCLubUserRow['subscription_status'] === 'paid'){ 
                    include('ui-components/pending_meeting_card_active.php'); 
                    include('ui-components/upcoming_meeting_card_active.php'); 
                } else {
                    $Inactive_card_title = 'Approve Booking';
                    $Inactive_card_titleIcon = 'fa-calendar-days';
                    $Inactive_card_text = 'Unlock premium to get full access';
                    $Inactive_card_Btntext = 'Unlock Now';
                    
                    $Inactive_card_url = '/users/subscriptionplan.php';
                    include('ui-components/dashboard_card_inactive.php'); 
                    
                    $Inactive_card_title = 'Upcoming Meetings';
                    $Inactive_card_url_target = '_blank';
                    include('ui-components/dashboard_card_inactive.php'); 
                }
            ?>
                </div>
                ...
                <div class="col-xl-8 col-lg-12 col-md-12 mb-3" >
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="p-3 rounded-4 postReminder-card mb-3 min-height">
                                ...
                                <div class="card-header d-flex justify-content-between align-items-center" style=" border-bottom: 1px solid #333; ">
                                    ...
                                    <a href="/users/user.notifications.php" class="mb-2">View All</a>
                                </div>
                                ...
                                <?php 
                                    ...
                                    $rawconnections = $postObj->GetAllConnectionsByUserId($Userrow['ClubId'], 0); 
                                ...
                                ?>
                                   <div class="col-sm-12">
                                       <div class="alert alert-primary alert-dismissible fade show py-2" style="background: #05495800;border: 2px solid #08799000;color: #1ab5d5;" role="alert"> 
                                           ...
                                           <a href="/users/user.clubconnections.php" class="cs-btn cs-style2 py-1 px-3 cs-font_11 mt-2 ViewPostBtn">View </a>
                    ...
                    <div class="row">
                        ...
                        <?php $HelthScore = $postObj->getSocialHealthScoreByEmail($_SESSION['email']); 
                            ...
                            include("../social-health-impact/functions.php");
                            $SBObj = new SocialHealth();
                            $DataRow = $SBObj->getDataEmail($_SESSION['email']);
                            $Memberscount = $SBObj->getNoOfMembersCount();
                            include('../social-health-impact/graphdash/numericscore.php');
                        ...
                        ?>
                            <div class="p-3 rounded-4 postReminder-card mb-3 min-height">
                                <div class="card-header d-flex justify-content-between align-items-center" style=" border-bottom: 1px solid #333; ">
                                    ...
                                    <a href="/social-health-impact/graphdash/" target="_blank" class="mb-2">View Score</a>
                                </div>
                        ...
                        <?php } else { 
                                $Inactive_card_title = 'Social Health Assessment';
                                $Inactive_card_titleIcon = 'fa-chart-simple';
                                $Inactive_card_text = 'Take the assessment to view score';
                                $Inactive_card_Btntext = 'Take Now';
                                
                                $Inactive_card_url = '/social-health-impact/';
                                $Inactive_card_url_target = '_blank';
                                include('ui-components/dashboard_card_inactive.php'); 
                            } ?>
                        ...
                        if($WAQScore) {
                                ...
                                // FOR Wellness Assessment Score
                            require_once('../assessments/functions.php');
                            $obj = new Assessment();
                            $total_participants = $obj->GetCountOfTotalUsers();
                            $userScore = $obj->GetScoreByEmail($_SESSION['email']);
                            include('../assessments/calc_score.php');
                        ...
                        <div class="p-3 rounded-4 postReminder-card min-height mb-3">
                            <div class="card-header d-flex justify-content-between align-items-center" style=" border-bottom: 1px solid #333; ">
                                ...
                                <a href="/assessments/report.php?fiticon=<?=$WAQScore['slug']?>" target="_blank" class="mb-2">View Score </a>
                            </div>
                            <div class="card-body pt-2">
                        ...
                        <?php } else { 
                                $Inactive_card_title = 'Wellness Assessment';
                                $Inactive_card_titleIcon = 'fa-chart-simple';
                                $Inactive_card_text = 'Take the assessment to view score';
                                $Inactive_card_Btntext = 'Take Now';
                                
                                $Inactive_card_url = '/assessments/wellness-assessment.php';
                                $Inactive_card_url_target = '_blank';
                                include('ui-components/dashboard_card_inactive.php'); 
                            } ?>
...
<script>
  ...
  <script type="text/javascript">
    ...
    <script>
        ...
        //WAQ Score
        var wellnessscore = {
          series: [<?=$INDIVIDUAL_WELLBEING_SCORE?>],
          chart: {
          type: 'radialBar',
          offsetY: -20,
          sparkline: {
