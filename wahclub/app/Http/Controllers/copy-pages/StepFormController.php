...
class StepFormController extends Controller
{
    ...
    public function getUserPortfolioBySlug($slugUsername)
    {
        ...
        return view('mypresence', compact('user', 'story', 'socials', 'skills', 'tools', 'UserAttributes', 'projects', 'experiences', 'educations', 'awards', 'testimonials', 'blogs', 'loggedinUser', 'connections', 'timezones', 'availabilities', 'mytimezone'));
    }
            ...
            if ($request->input('StoryType') == "OLDStory") {
              ...
              if (!empty($request->input('WAH_storyTitle')) && !empty($request->input('WAH_Story'))) {
                ...
                if ($q1 !== null && $q2 !== null && $q3 !== null && $q4 !== null && $q5 !== null) {
                    ...
                    $storyData['title'] = $request->input('freshstoryTitle') ?? null;
                } else{
    ...
    */
    ...
    public function bookaslot(Request $request)
    {
      try {
        ...
        $onlyTime = $date->format('Y-m-d H:i:s');
    ...
    //Member Details
     ...
     // Check if the logged-in user exists
        ...
        if (!empty($_SESSION['email'])) {
            ...
            $booking->slot_date = $onlyDate;
            $booking->start_time = $onlyTime;
            $booking->end_time = $onlyTime;
