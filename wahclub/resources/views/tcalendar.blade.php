...
<body>
    ...
    <main class="site-content" > 
                    ...
                    <div class="available-slots" id="AvailableSlots">
                        <div class="toptags-widget wow fadeInRight mb-4" data-wow-delay=".5s" data-wow-items="3">
                            <div class="owl-carousel toptags-carousel" ata-items="3">
                                ...
                                $JumptonextDay = '';
                    //Exceptions Dates
                    $expDates = array('2025-03-01', '2025-03-04', '2025-03-07');
                                ?>
        ...
        //Setting Exceptions
            if(in_array($LoopDateInMemberTZ, $expDates)) {
                $ReturnedSchedule = '';
            }
            //Setting Exceptions Ends
                   ...
                   <div class="row">
                    ...
                    <div class="row align-items-center text-center g-2">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 pt-4 ">
                             <a href="/wahclub/thankyou" class="btn tj-btn-primary-new px-5 py-3 mb-3"> Book Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
                        ...
                        <div class="intro-video-play-button">
  ...
  <script>
  //Exception Dates
  	const ExceptionDates = ["2025-02-28", "2025-03-03", "2025-03-07", "2025-03-10"];
   ...
   $(document).ready(function ($) {
    ...
    function GenerateTimeSlots (StartTimeG, EndTimeG) {
        ...
        //Booked Hour Slot
            ...
            var bookedDate = StartTime.toLocaleDateString('en-CA').split('T')[0]
            ...
            if(bookedSlot == '14:30:00' && ExceptionDates.includes(bookedDate)) {
