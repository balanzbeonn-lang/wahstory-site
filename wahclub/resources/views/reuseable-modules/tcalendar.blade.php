  ...
  <script>
   ...
   $(document).ready(function ($) {
    ...
    function GenerateTimeSlots (StartTimeG, EndTimeG) {
        ...
        console.log("Start Time: " + StartTime.toLocaleDateString('en-CA').split('T')[0]);
    ...
    window.onload = function(){
	   ...
	   var EndTimeG = date.split(' ')[0] + ' ' + endtime;
        ...
        console.log('This is the Un-converted time: ' + StartTimeG);
        console.log('This is the converted time: ' + startdatetimeA);
        
        var newStartTime = addMoreHoursInStartTime(StartTimeG, timezoneB);
       
       
        console.log('This is the converted time New : ' + newStartTime);
