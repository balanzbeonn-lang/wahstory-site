	...
	<div class="category-item">
        ...
        <div class="content">
			<h4 class="name"> 
    			<a href="/wahclub/{{ $user->slug_username }}" title="{{ $user->firstname }} {{ $user->lastname }}">{{ $user->firstname }} {{ $user->lastname }} 
            ...
            @endphp
				...
				<span title="Experience">
				    <i class="fa-thin fa-sharp fa-suitcase"></i> {{ $user->totalexperience }} year+
				</span>
			</div>
