...
<body>
    ...
    <main class="site-content" > 
            ...
            <div class="container">
                ...
                // var_dump($filteredSchedule);
                        ...
                        foreach ($filteredSchedule as &$schedule) {
                            ...
                            $schedule['user_id'] = (string) $schedule['user_id'];
                        }
        ...
        $ReturnedSchedule = CheckSchedule($schedules, $LoopDayNameMemberTZ, 251);
                   ...
                   <div class="row">
                    ...
                    <div class="row align-items-center text-center g-2">
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 pt-4 ">
                             <a href="/wahclub/thankyoutest" class="btn tj-btn-primary-new px-5 py-3 mb-3"> Book Now <i class="fa fa-arrow-right"></i></a>
                        </div>
                    </div>
  ...
  <script>
   ...
   $(document).ready(function ($) {
    ...
    function GenerateTimeSlots (StartTimeG, EndTimeG) {
        ...
        //Booked Hour Slot
            var bookedSlot = StartTime.toTimeString().split(' ')[0];
...
// The offset is in minutes, and it's negative for timezones ahead of UTC, 
// and positive for timezones behind UTC.
...
<?php
        /*$LoopDateStartTime = $LoopDateInUserTZ.' '.$filteredSchedule[0]['start_time'];
        $LoopDateENDTime = $LoopDateInUserTZ.' '.$scheduleEndtime; 
        
        $formattedStartTimeInMemberTZ = Carbon::parse($LoopDateStartTime, $UserTimeZone)->setTimezone($memberTimeZone);
        $Abcds = Carbon::parse($LoopDateStartTime, $UserTimeZone)->setTimezone($memberTimeZone);
        $formattedENDTimeInMemberTZ = Carbon::parse($LoopDateENDTime, $memberTimeZone)->setTimezone($UserTimeZone);*/
